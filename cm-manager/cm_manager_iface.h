...
*/
	...
	void (*list_modems)(struct cm_manager_iface *self,
			    ...
			    void *userdata,
			    cm_err_t *err);
/*	struct cm_object *(*get)(struct cm_manager_iface *self);
	void (*put)(struct cm_manager_iface *self);
 ...
 */
struct cm_manager_iface * cm_manager_iface_new(struct cm_module *module);
